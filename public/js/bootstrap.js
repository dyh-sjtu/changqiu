...
(function (global, factory) {
	...
	var Carousel = function ($$$1) {
		...
		var ClassName = {
			CAROUSEL: 'changqiu-carousel',
			ACTIVE: 'changqiu-active',
			SLIDE: 'changqiu-slide',
			RIGHT: 'changqiu-carousel-item-right',
			LEFT: 'changqiu-carousel-item-left',
			NEXT: 'changqiu-carousel-item-next',
			PREV: 'changqiu-carousel-item-prev',
			ITEM: 'changqiu-carousel-item'
		};
		var Selector = {
			ACTIVE: '.changqiu-active',
			ACTIVE_ITEM: '.changqiu-active.changqiu-carousel-item',
			ITEM: '.changqiu-carousel-item',
